...
public class SQLiteHelper
{
    ...
    //
    private static string DBPath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().GetName().CodeBase)+ "\\TrainDB.db";
    ...
    {
        //原语句—string strsql = "select max(" + FieldName + ")+1 from " + TableName;//可能是原来的早期sqlite版本问题
...
/// <returns></returns>
    ...
    /// <returns></returns>
    public static string ReturnFirstRowCols(string SQLString)
    {
